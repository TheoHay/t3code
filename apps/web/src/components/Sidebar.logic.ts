...
export function resolveThreadRowClassName(input: {
  ...
  if (input.isSelected && input.isActive) {
    return cn(
      baseClassName,
      "sidebar-active-thread bg-sidebar-row-active text-sidebar-foreground font-medium ring-1 ring-inset ring-primary/20 hover:bg-sidebar-row-active hover:text-sidebar-foreground",
    );
  }
